...
<%
	...
	int matMemSeq = Integer.parseInt(StringUtil.nchk(request.getParameter("matMemSeq"),"0"));
	int gubun = Integer.parseInt(StringUtil.nchk(request.getParameter("gubun"),"1"));				//1 : 즐겨찾기 등록, 2: 취소

	MemberDao dao = new MemberDao();
	int result = dao.bestFriendUpdate(memSeqNo, matMemSeq, gubun);
	//dao = new MemberDao();
