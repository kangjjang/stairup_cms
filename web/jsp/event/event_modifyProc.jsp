...
<%
	...
	try{
		String uploadFolder = Constant.PHOTO_UPLOAD_URL_EVENT;
		...
		String evnetTitle = StringUtil.nchk(mul.getParameter("event_title"),"");
		...
		result = dao.update(no,wbContent, evnetTitle, imgAddre, affiliation);
	/* 	if(photoChg){
