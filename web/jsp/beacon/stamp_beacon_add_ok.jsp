...
<%
	...
	try {
		...
		int stampEventSeq = dao.insertStampEvent(stampEventTarget, stampEventName, stampEventRegion, stampEventAddress, stampEventCourseDistance, stampEventCourseTime,
