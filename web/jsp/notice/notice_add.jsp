...
%>
<%
	 FCKeditor fckEditor = new FCKeditor(request, "notiContent", "700", "300", "Audi", "", addPath + "/fckeditor"); 
%>
		...
		<div id="wrap">
			...
			<div id="contentWrap">  
				...
				<div class="contentArea">
					<h2 class="contentTitle">공지 사항 입력</h2>
					<form name="frm" action="notice_addProc.jsp" method="post" enctype="multipart/form-data">
