		...
		<div id="wrap">
			...
			<div id="contentWrap">  
				...
				<div class="contentArea">
					<h2 class="contentTitle">국가 입력</h2>
					<form name="frm" action="country_addProc.jsp" method="post" enctype="multipart/form-data">
					<div class="contentForm">
						<table class="detailInfoOneItem" style="margin-top: -20px;">
							...
							<tr class="detailInfoOneItemFirst"> 
							  <th>국가명 *</th>
							  <td><input type="text" name="countryName" size="50" class="box formfield" /></td>
							</tr>
							<tr > 
							   <th>이미지</th>
