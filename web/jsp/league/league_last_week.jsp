...
<%
	...
	String subMenuCate = Constant.SUBMENU_LAST_WEEK;
...
/* 	String notiType = StringUtil.nchk(request.getParameter("notiType"), "0"); */
	...
	ArrayList<DepartVO> list = dao.selectTimeLeagueList(pageno, 10,1);
	//dao = new DepartDao();
		...
		<div id="wrap">
			...
			<div id="contentWrap">  
				...
				<div class="contentArea">
					<h2 class="contentTitle">팀별리그 지난 경기 관리</h2>
				...
				<%-- 		<input type="hidden" name="notiType" value="<%=notiType%>"> --%>
						...
						<div class="alignRightButton">
					      	...
					      	<button type="button" OnClick="location.href='league_reset.jsp';">초기화</button>
					    </div>							
					</div>
				</div>
			</div>
